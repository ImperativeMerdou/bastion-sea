...
export const ghostlightConquestScene: StoryScene = {
  ...
  beats: [
    ...
    {
      id: 'ghostlight_conquest_03_trap',
      title: 'THE AFTERMATH',
      requireFlagValue: { flag: 'ghostlight_trap', value: true },
      effect: 'heavy_shake',
      sfx: 'combat_cinematic_boom',
      paragraphs: [
        'The trap works at the twenty-first minute. Kovesse doesn\'t announce it. She closes her Grimoire, and the light column collapses, and the water goes still.',
        'The leviathan took the light the way everything in the dark takes light. The same instinct that predates intelligence. It rose toward it, and then it was gone. The body is sixty feet down in the thermal channels now, feeding the reef.',
        'The fishers knew before the monitors confirmed it. The stilt-houses had gone quiet in the way that only happens when something massive stops moving below the water. By the time you looked up, they were already at the dock edges.',
        'Fifteen hundred people, lining the walkways in the dark. Nobody speaks.',
        'A child throws a flower. One of the reef orchids that grow on the stilt-house roofs, small, white, fragile. Then another. Then the walkways are raining white petals into the ghostlight, and the bioluminescence washes against the dock pilings in steady blue rhythm, and the fishers are acknowledging something. In their own way, in the language of the reef.',
        'You have no idea what to do with any of it.',
      ],
    },
    {
      id: 'ghostlight_conquest_03_lair',
      title: 'THE AFTERMATH',
      requireFlagValue: { flag: 'ghostlight_track_lair', value: true },
      effect: 'heavy_shake',
      sfx: 'combat_cinematic_boom',
      paragraphs: [
        'Suulen finds the canyon at the sixteenth minute. Sixty feet down, in the cold dark where the reef meets the shelf. The leviathan is already slowing. Already aware, at some pre-language level, that the depth is wrong. That it is not alone.',
        'You don\'t give it time to finish that thought.',
        'The body stays in the canyon. You come up in the shallows near the central dock, breathing hard, saltwater streaming from your hair. The ghostlight steadies around you. Blue. Green. Purple. The tidal pulse resuming as if it had never been interrupted.',
        ...
        'A child throws a flower. One of the reef orchids that grow on the stilt-house roofs, small, white, fragile. It lands in the glowing water next to you and drifts there, caught in the bioluminescence, petals lit from below.',
        'Then another flower. Then a handful. Then the walkways are raining white petals into the ghostlight, and the fishers are not cheering, fishers don\'t cheer, they are quiet, practical people, but they are doing something. Acknowledging. In their own way, in the language of the reef.',
        'You have no idea what to do with any of it.',
      ],
    },
    {
      ...
      title: 'THE AFTERMATH',
      requireFlagValue: { flag: 'ghostlight_direct_fight', value: true },
      effect: 'heavy_shake',
      sfx: 'combat_cinematic_boom',
      paragraphs: [
