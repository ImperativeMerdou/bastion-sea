...
export const windrowArrivalScene: StoryScene = {
  id: 'explore_windrow',
  title: 'WINDROW - THE CLIFF THAT SPEAKS',
  beats: [
    {
    ...
    {
      id: 'windrow_arrive_02',
      speaker: 'dragghen',
      speakerName: 'Dragghen Kolve',
      paragraphs: [
        'The dock, if you can call it that, is a reinforced timber platform recessed into a carved alcove in the cliff face. The alcove blocks enough wind to keep the ship from being smashed against the rock, but "enough" is relative. Ropes creak. The hull groans. Suulen ties off with knots that look like they were invented by someone who expected the ocean to personally try to undo them.',
        'A receiving party waits on the platform. Four humans in heavy oilskin coats, hoods up, faces weathered to leather by years of wind exposure. They carry no weapons, but their stances say they don\'t need them. Working hands. Calloused, scarred, thick-fingered. Quarriers. Timber cutters. People who wrestle stone and wood for a living and consider the wind a coworker, not an enemy.',
        'Dragghen stops on the gangplank. He\'s staring at their hands.',
        '"Captain," he says quietly, and his voice has gone soft. Recognition. "Those are miner\'s hands. Different calluses, same wear. These people work the rock."',
        '"You grew up in rock."',
        '"Coppervein. Underground. These bastards do it on a cliff face with THAT--" He gestures at the wind, which obligingly tries to rip the words from his mouth. "--trying to kill them every day. That\'s not mining. That\'s war."',
        'The lead dockworker, a woman in her fifties with a jaw like a shovel blade and eyes narrowed to permanent slits against the wind, looks up at you. All the way up. Past the boots. Past Danzai. Past the horns.',
        '"Oni," she says. An observation, the same way she might note a change in the wind speed.',
        '"Big one," says the man beside her.',
        '"They\'re all big," she says. "Doesn\'t mean they\'re useful."',
        'Dragghen laughs. A real laugh, surprised out of him. The dockworkers look at the Gorundai the way people look at someone they weren\'t expecting to understand.',
        '"I like her," Dragghen says.',
      ],
    },
    {
      id: 'windrow_arrive_03',
      speaker: 'dragghen',
      speakerName: 'Dragghen Kolve',
      paragraphs: [
        'The path up the cliff is a series of switchback stairs carved directly into the stone, with timber railings bolted into the rock every ten feet. The railings aren\'t decorative. Without them, the wind would send you over the edge and into three hundred feet of open air before you had time to swear about it.',
        'You climb with Danzai on your back. Your horns catch the wind like sails. The forward curve channels the gale around your skull in a way that\'s technically aerodynamic and practically annoying. Every few steps, a gust hits hard enough to make even you plant your feet and wait.',
    ...
    {
      id: 'windrow_arrive_04',
      title: 'THE COUNCIL',
      paragraphs: [
        'The council chamber is the deepest room on Windrow, carved fifty feet into the cliff face, past two sets of windbreak doors, into a stone hall where the air is finally, mercifully still. The silence hits you like a physical thing. After an hour of screaming wind, the absence of it makes your ears ring.',
        'Five people sit behind a curved stone table. They\'re mid-argument when you arrive.',
        'A woman built like a barrel is jabbing a finger at a map of the cliff face. "The section four braces are failing because we used greenwood and I TOLD you we needed seasoned timber--"',
        'A man with arms thicker than Kovesse\'s entire body shakes his head. Stone dust is permanently embedded in the creases of his hands. "The rock shifted. Not the timber. I\'ve been quarrying this cliff for twenty years, Maeven--"',
    ...
    },
    {
      ...
      choices: [
        {
          id: 'windrow_observe_council',
          text: '"I want to watch. Your council was arguing about something before I walked in. Finish it."',
          consequence: 'Watch. Learn their game.',
          available: true,
          effects: [
            { type: 'resource', target: 'intelligence', value: 8 },
            { type: 'reputation', value: 2 },
            { type: 'flag', target: 'windrow_observed_council', value: true },
          ],
        },
        {
          id: 'windrow_announce_bold',
          text: '"I want this island. And I wanted you to see me say it to your faces, because I don\'t take things from behind people\'s backs."',
          consequence: 'Blunt. Honest.',
          available: true,
          effects: [
            { type: 'reputation', value: 6 },
            { type: 'infamy', value: 3 },
            { type: 'flag', target: 'windrow_announced_bold', value: true },
          ],
        },
        {
          id: 'windrow_send_dragghen',
          text: '"Dragghen. Go talk to the workers outside. I want to know this island from the ground up."',
          consequence: 'Ground up. Send the miner.',
          available: true,
          effects: [
            { type: 'loyalty', target: 'dragghen', value: 8 },
            { type: 'resource', target: 'intelligence', value: 5 },
            { type: 'reputation', value: 3 },
            { type: 'flag', target: 'windrow_dragghen_workers', value: true },
          ],
        },
      ],
    },
    ...
    {
      id: 'windrow_arrive_06',
      title: 'THE EDGE',
      paragraphs: [
        'You find the overlook alone.',
        'The highest point on Windrow. Bare rock above the settlement, exposed to the full force of the gale. No windbreak. No railing. Just stone and sky, and a drop that goes straight down into churning white water three hundred feet below. The gale has been carving this rock for millennia. It has worn down mountains.',
        'You plant your feet. Danzai drives into the stone beside you. The war club\'s iron spikes bite into the rock and hold.',
        'Below, Windrow spreads across the cliff face. Timber and stone lashed with rope, built by people who decided that a cliff in a permanent gale was a perfectly good place to raise children. Twenty-eight hundred people who argue about load-bearing ratios at two in the morning and don\'t have time for tyrants because they\'re too busy not dying.',
        'You don\'t walk in here with a sword and call it yours.',
        'You look out over the Bastion Sea. The Southern Reach stretches south, grey water and islands you haven\'t set foot on yet.',
        'There\'s work to do before this place makes sense. Dragghen already has ideas about the section four reinforcements. Delvessa will want trade projections. The council needs a reason, not a speech.',
        'You turn. Walk down the cliff. The wind shoves at your back the whole way.',
        'That\'s fine. You\'ll need to come back with something better than words anyway.',
      ],
    },
  ],
  onComplete: [
    { type: 'flag', target: 'windrow_explored', value: true },
    { type: 'resource', target: 'intelligence', value: 10 },
    { type: 'notification', value: true, notification: {
      type: 'story',
      title: 'WINDROW - SCOUTED',
      message: 'Windrow\'s council is divided on external relations. Chair Maeven Ruhl holds the deciding vote, but the working population respects action over words. The cliff-face settlement is vulnerable to structural failures, a problem they lack the expertise to solve. Dragghen Kolve has made contact with the quarry workers.',
    }},
    { type: 'notification', value: true, notification: {
      type: 'crew',
      title: 'DRAGGHEN KOLVE - Overheard',
      message: 'Dragghen has requested oversight on Windrow operations. Says he knows the quarry workers and wants to handle initial contact personally.',
    }},
  ],
  currentBeat: 0,
};
