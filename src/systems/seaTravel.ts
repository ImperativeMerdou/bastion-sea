  ...
  // === COMBAT ENCOUNTERS AT SEA ===
  {
    ...
    choices: [
      ...
      },
      {
        ...
        successChance: 70,
        failText: 'You step out. Full height. Horns. Iron. The pirate captain looks you up and down... and laughs. "Big don\'t mean scary, goat-boy. GET HIM." They rush you. The brawl is short, ugly, and leaves dents in the railing. They retreat with fewer teeth. So do you.',
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        effects: { supplies: -5 },
        successChance: 60,
        failText: 'Suulen tries to read the current but the beast is faster than the water. It rams the hull, HARD, and the ship staggers. Timbers crack. Dragghen swears in Gorundai and grabs Bulkhead. The thing surfaces, all teeth and rage. You drive it off with the Danzai and raw stubbornness, but the hull took real damage.',
        failEffects: { supplies: -12, materials: -5 },
      },
    ],
  },
  {
